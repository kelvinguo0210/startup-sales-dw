      ...
      <div className={ styles.mhContent}>
        ...
        <div className={styles.right}>
          ...
          <Balloon
            align="bl"
            visible={visible}
            trigger={<div style={{ display: 'none' }} className={styles.userInfo}>{notLogin ? <Translation>Not logged in</Translation> : loginInfo?.userName || <Translation>Not logged in</Translation>}</div>}
            triggerType="hover"
