...
class ExperimentList extends BaseModel {
  ...
  *getGeneralWorkSpaceStatInfo(payload: any) {
    ...
    const res = yield this.effects.call(createServiceChaos('GetGeneralWorkSpaceStatInfo'), payload);
    return res?.Data || { Data: { active: 1, exception: 2, exceptionCount: 3, failure: 4, failureCount: 5, finished: 6, finishedCount: 7, idle: 8, running: 0, runningCount: 10, success: 11, total: 12, totalCount: 13 } };
  }
