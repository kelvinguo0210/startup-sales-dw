...
class WorkSpace extends BaseModel {
  ...
  *getExperimentSummary() {
    ...
    const res = yield this.effects.call(createServiceChaos('GetExperimentSummary'));
    return res?.Data || { unexpectedSize: 10, successSize: 20, totalSize: 30, unexpectedRatio: 0.2, successRatio: 0.8 };
  }
